...
<tr>
    ...
    <select name="data[payment][payment_params][WidjetLang]">
          ...
          <option <?if ($this->element->payment_params->WidjetLang=='cs-CZ') echo 'selected';?> value="cs-CZ"><?=GetLang('SALE_HPS_WIDGET_LANG_TYPE_9')?></option>
    </select>
	</td>
</tr>
...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][Widjetskin]"><?php
			echo GetLang('SALE_HPS_CLOUDPAYMENT_WIDGET_SKIN');
		?></label>
	</td>
	<td>
    <select name="data[payment][payment_params][Widjetskin]">
          <option <?if ($this->element->payment_params->Widjetskin=='classic') echo 'selected';?> value="classic" selected=""><?=GetLang('SALE_HPS_WIDGET_SKIN_0')?></option>
          <option <?if ($this->element->payment_params->Widjetskin=='modern') echo 'selected';?> value="modern"><?=GetLang('SALE_HPS_WIDGET_SKIN_1')?></option>
          <option <?if ($this->element->payment_params->Widjetskin=='mini') echo 'selected';?> value="mini"><?=GetLang('SALE_HPS_WIDGET_SKIN_2')?></option>
    </select>
	</td>
</tr>
...
<tr>
    ...
    <select name="data[payment][payment_params][PAYMENT_CURRENCY]">
        ...
        <option <?if ($this->element->payment_params->PAYMENT_CURRENCY=='ZAR') echo 'selected';?> value="ZAL"><?=GetLang("ZAR")?></option>
        <option <?if ($this->element->payment_params->PAYMENT_CURRENCY=='UZS') echo 'selected';?> value="UZS"><?=GetLang("UZS")?></option>
        <option <?if ($this->element->payment_params->PAYMENT_CURRENCY=='BGL') echo 'selected';?> value="BGL"><?=GetLang("BGL")?></option>
    </select>    
	</td>
</tr>
